...
;(function($) {
  ...
  var Carousel = function( element, options ) {
    ...
    this.xRadius = (options.xRadius === null) ? $container.width()  / 7.3 : options.xRadius;
    ...
    this.enableAutoPlay = function() {
      ...
      $container.bind( 'touchmove.cloud9', function() {
    ...
    this.bindControls = function() {
      if( options.buttonLeft ) {
        options.buttonLeft.bind( 'touchmove.cloud9', function() {
          self.go( -1 );
          return false;
        } );
      }
      ...
      if( options.buttonRight ) {
        options.buttonRight.bind( 'touchmove.cloud9', function() {
          self.go( 1 );
          return false;
        } );
      }
      ...
      if( options.mouseWheel ) {
        $container.bind( 'touchmove.cloud9', function( event, delta ) {
          self.go( (delta > 0) ? 1 : -1 );
          return false;
        } );
      }
      ...
      if( options.bringToFront ) {
        $container.bind( 'touchmove.cloud9', function( event ) {
